...
var _user$project$Sort$exchange = F5(
	function (i1, e1, i2, e2, array) {
		return A3(
			_elm_lang$core$Array$set,
			i1,
			e2,
			A3(_elm_lang$core$Array$set, i2, e1, array));
	});
var _user$project$Sort$animToSteps = function (_p0) {
	var _p1 = _p0;
	return _p1._0._1;
};
var _user$project$Sort$animToList = function (_p2) {
	var _p3 = _p2;
	return _elm_lang$core$Array$toList(_p3._0._0);
};
var _user$project$Sort$Animator = function (a) {
	return {ctor: 'Animator', _0: a};
};
var _user$project$Sort$listToAnimator = function (list) {
	return _user$project$Sort$Animator(
		{
			ctor: '_Tuple2',
...
var _user$project$Sort$UnlookAt = function (a) {
	return {ctor: 'UnlookAt', _0: a};
};
var _user$project$Sort$unlook = F2(
	function (i, _p4) {
		var _p5 = _p4;
		return _user$project$Sort$Animator(
			{
				...
				_1: A2(
					...
					{
						ctor: '::',
						_0: _user$project$Sort$UnlookAt(i),
						_1: {ctor: '[]'}
					})
			});
	});
var _user$project$Sort$LookAt = function (a) {
	return {ctor: 'LookAt', _0: a};
};
var _user$project$Sort$Exchange = F2(
	function (a, b) {
		return {ctor: 'Exchange', _0: a, _1: b};
	});
var _user$project$Sort$moveBack = F2(
	function (i, _p6) {
		moveBack:
		while (true) {
			var _p7 = _p6;
			var _p9 = _p7._0._0;
			var _p8 = _p7;
			if (_elm_lang$core$Native_Utils.cmp(i - 1, 0) < 0) {
				return A2(_user$project$Sort$unlook, i, _p8);
			} else {
				var exchElem = A2(_elm_community$array_extra$Array_Extra$getUnsafe, i - 1, _p9);
				var currentElem = A2(_elm_community$array_extra$Array_Extra$getUnsafe, i, _p9);
				if (_elm_lang$core$Native_Utils.cmp(currentElem, exchElem) < 0) {
					var _v4 = i - 1,
						_v5 = _user$project$Sort$Animator(
						A2(
							F2(
								function (v0, v1) {
									return {ctor: '_Tuple2', _0: v0, _1: v1};
								}),
							A5(_user$project$Sort$exchange, i, currentElem, i - 1, exchElem, _p9),
							A2(
								_elm_lang$core$Basics_ops['++'],
								_p7._0._1,
								{
									ctor: '::',
									_0: A2(_user$project$Sort$Exchange, i, i - 1),
									_1: {ctor: '[]'}
								})));
					i = _v4;
					_p6 = _v5;
...
var _user$project$Sort$sort_ = F2(
	function (index, _p10) {
		sort_:
		while (true) {
			var _p11 = _p10;
			...
			if (_elm_lang$core$Native_Utils.cmp(
				index,
				_elm_lang$core$Array$length(_p12)) < 0) {
				var animUpdated = A2(
					_user$project$Sort$moveBack,
					index,
					_user$project$Sort$Animator(
						{
							ctor: '_Tuple2',
							_0: _p12,
							_1: A2(
								...
								{
									ctor: '::',
									_0: _user$project$Sort$LookAt(index),
									_1: {ctor: '[]'}
								})
						}));
				var _v7 = index + 1,
...
var _user$project$Sort$sort = function (_p13) {
	return A2(
		_user$project$Sort$sort_,
		1,
		_user$project$Sort$listToAnimator(_p13));
};

var _user$project$Main$calculateY = function (status) {
	var _p0 = status;
	if (_p0.ctor === 'Normal') {
		return 0;
	} else {
...
var _user$project$Main$calculateX = F2(
	function (x, y) {
		return x * y;
	})(120);
var _user$project$Main$updatePositionAnimation = function (e) {
	return _elm_lang$core$Native_Utils.update(
		e,
		{
			position: function () {
				var y = _mdgriffith$elm_style_animation$Animation$px(
					_elm_lang$core$Basics$toFloat(
						_user$project$Main$calculateY(e.status)));
				var x = _mdgriffith$elm_style_animation$Animation$px(
					_elm_lang$core$Basics$toFloat(
						_user$project$Main$calculateX(e.index)));
				return A2(
					_mdgriffith$elm_style_animation$Animation$interrupt,
					{
						...
						_0: _mdgriffith$elm_style_animation$Animation$to(
							{
								ctor: '::',
								_0: A2(_mdgriffith$elm_style_animation$Animation$translate, x, y),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					},
...
var _user$project$Main$stepExchange = F3(
	function (i1, i2, array) {
		var e2 = A2(_elm_community$array_extra$Array_Extra$getUnsafe, i2, array);
		var e1 = A2(_elm_community$array_extra$Array_Extra$getUnsafe, i1, array);
		return function (e) {
			return A2(_elm_lang$core$Array$set, i2, e);
		}(
			_user$project$Main$updatePositionAnimation(
				_elm_lang$core$Native_Utils.update(
					e1,
					{index: i2})))(
			function (e) {
				return A3(_elm_lang$core$Array$set, i1, e, array);
			}(
				_user$project$Main$updatePositionAnimation(
					_elm_lang$core$Native_Utils.update(
						e2,
...
var _user$project$Main$setStatusInArray = F3(
	function (status, index, array) {
		return function (e) {
			return A3(_elm_lang$core$Array$set, index, e, array);
		}(
			function (e) {
				return _elm_lang$core$Native_Utils.update(
					e,
					{
						...
						position: function () {
							var y = _mdgriffith$elm_style_animation$Animation$px(
								_elm_lang$core$Basics$toFloat(
									_user$project$Main$calculateY(status)));
							var x = _mdgriffith$elm_style_animation$Animation$px(
								_elm_lang$core$Basics$toFloat(
									_user$project$Main$calculateX(index)));
							return A2(
								_mdgriffith$elm_style_animation$Animation$interrupt,
								{
									ctor: '::',
				...
				A2(_elm_community$array_extra$Array_Extra$getUnsafe, index, array)));
	});
var _user$project$Main$second = function (_p1) {
	var _p2 = _p1;
	return _p2._1;
};
var _user$project$Main$statusToColor = function (status) {
	var _p3 = status;
	if (_p3.ctor === 'Normal') {
		return '#000';
	} else {
...
var _user$project$Main$intBox = function (e) {
	return A2(
		_elm_lang$svg$Svg$g,
		_mdgriffith$elm_style_animation$Animation$render(e.position),
		{
			ctor: '::',
			_0: A2(
									...
									_1: {
										...
										_1: {
											...
											_0: _elm_lang$svg$Svg_Attributes$fill(
												_user$project$Main$statusToColor(e.status)),
											_1: {ctor: '[]'}
										}
									}
								}
				...
				_0: A2(
					_elm_lang$svg$Svg$rect,
					{
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$width('90'),
								_1: {
									ctor: '::',
				...
				_1: {
					...
					_0: A2(
						_elm_lang$svg$Svg$text_,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$y('73'),
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$textAnchor('middle'),
									_1: {
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$fontSize('70px'),
										_1: {ctor: '[]'}
									}
								}
							}
						},
						{
							...
							_0: _elm_lang$svg$Svg$text(
								_elm_lang$core$Basics$toString(e.value)),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$Main$backwardTimeline = F3(
	function (currentAnim, prevAnims, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				steps: {ctor: '::', _0: currentAnim, _1: model.steps},
				history: prevAnims
			});
	});
var _user$project$Main$forwardTimeline = F3(
	function (currentAnim, rest, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				steps: rest,
				history: {ctor: '::', _0: currentAnim, _1: model.history}
			});
	});
var _user$project$Main$flipStep = function (animation) {
	var _p4 = animation;
	switch (_p4.ctor) {
		case 'Exchange':
			return A2(_user$project$Sort$Exchange, _p4._1, _p4._0);
		case 'LookAt':
			return _user$project$Sort$UnlookAt(_p4._0);
		default:
			return _user$project$Sort$LookAt(_p4._0);
	}
};
var _user$project$Main$defaultArray = {
	ctor: '::',
	_0: 88,
	_1: {
		ctor: '::',
...
var _user$project$Main$updatePosition = F2(
	function (msg, element) {
		return _elm_lang$core$Native_Utils.update(
			element,
			{
				position: A2(_mdgriffith$elm_style_animation$Animation$update, msg, element.position)
			});
	});
var _user$project$Main$getPosition = function (e) {
	return e.position;
};
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {array: a, steps: b, history: c, playing: d};
	});
var _user$project$Main$Element = F4(
	function (a, b, c, d) {
		return {value: a, index: b, position: c, status: d};
	});
var _user$project$Main$LookedAt = {ctor: 'LookedAt'};
		...
		switch (_p5.ctor) {
			case 'Exchange':
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						array: A3(_user$project$Main$stepExchange, _p5._0, _p5._1, model.array)
					});
			case 'LookAt':
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						array: A3(_user$project$Main$setStatusInArray, _user$project$Main$LookedAt, _p5._0, model.array)
					});
			default:
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						array: A3(_user$project$Main$setStatusInArray, _user$project$Main$Normal, _p5._0, model.array)
					});
		}
	});
var _user$project$Main$constructArray = function (numbers) {
	var y = _mdgriffith$elm_style_animation$Animation$px(0);
	var l = _elm_lang$core$List$length(numbers);
	var indices = A2(_elm_lang$core$List$range, 0, l - 1);
	var styles = A2(
		_elm_lang$core$List$map,
		...
		A2(
			...
			A2(
				_elm_lang$core$List$map,
				function (x) {
					return A2(_mdgriffith$elm_style_animation$Animation$translate, x, y);
				},
				A2(
					_elm_lang$core$List$map,
					...
					A2(
						...
						function (_p6) {
							return _elm_lang$core$Basics$toFloat(
								_user$project$Main$calculateX(_p6));
						},
						indices)))));
	var yList = A2(_elm_lang$core$List$repeat, l, 0);
	var colorList = A2(_elm_lang$core$List$repeat, l, _user$project$Main$Normal);
	return _elm_lang$core$Array$fromList(
		A5(_elm_lang$core$List$map4, _user$project$Main$Element, numbers, indices, styles, colorList));
};
var _user$project$Main$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	{
		array: _user$project$Main$constructArray(_user$project$Main$defaultArray),
		steps: _user$project$Sort$animToSteps(
			_user$project$Sort$sort(_user$project$Main$defaultArray)),
		history: {ctor: '[]'},
		playing: false
	},
	{ctor: '[]'});
var _user$project$Main$Animate = F2(
	function (a, b) {
		...
		A2(
			...
			function (i) {
				return A2(
					...
					_user$project$Main$Animate(i),
					{
						ctor: '::',
						_0: A2(_elm_community$array_extra$Array_Extra$getUnsafe, i, model.array).position,
						_1: {ctor: '[]'}
					});
			},
			A2(
				_elm_lang$core$List$range,
				0,
				_elm_lang$core$Array$length(model.array) - 1)));
};
var _user$project$Main$StepForward = {ctor: 'StepForward'};
var _user$project$Main$StepBackward = {ctor: 'StepBackward'};
var _user$project$Main$StartClicked = {ctor: 'StartClicked'};
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				A2(
					_elm_lang$core$List$map,
					_user$project$Main$intBox,
					_elm_lang$core$Array$toList(model.array))),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
					{
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$class('buttons'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$StartClicked),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									model.playing ? 'Stop' : 'Start'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$class('blue-button'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$StepBackward),
										_1: {ctor: '[]'}
									}
								},
								{
							...
							_1: {
								...
								_0: A2(
									_elm_lang$html$Html$button,
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$StepForward),
											_1: {ctor: '[]'}
										}
									},
									{
...
var _user$project$Main$delayAndStepNext = A2(_user$project$Main$delay, _elm_lang$core$Time$millisecond * 800, _user$project$Main$NextStep);
		...
		switch (_p7.ctor) {
				...
				return A2(
					...
					function () {
						...
						if (_p8.ctor === '[]') {
							...
							var _p9 = _p8._0;
							return A3(
								_user$project$Main$forwardTimeline,
								_p9,
								_p8._1,
								A2(_user$project$Main$step, _p9, model));
						}
					}(),
					model.playing ? {
						ctor: '::',
						_0: _user$project$Main$delayAndStepNext,
						_1: {ctor: '[]'}
					} : {ctor: '[]'});
			case 'StartClicked':
				var _p10 = model.playing;
				if (_p10 === false) {
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
			...
			case 'StepBackward':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					function () {
						var _p11 = model.history;
						if (_p11.ctor === '[]') {
							return model;
						} else {
							var _p12 = _p11._0;
							return A3(
								_user$project$Main$backwardTimeline,
								_p12,
								_p11._1,
								A2(
									_user$project$Main$step,
									_user$project$Main$flipStep(_p12),
									model));
						}
					}(),
					{ctor: '[]'});
			case 'StepForward':
				var _p13 = model.steps;
				if (_p13.ctor === '[]') {
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						model,
					...
					return A3(
						...
						A3(
							...
							_p14,
							_p13._1,
							A2(_user$project$Main$step, _p14, model)));
				}
			default:
				var _p15 = _p7._0;
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						...
						{
							array: function (e) {
								return A3(_elm_lang$core$Array$set, _p15, e, model.array);
							}(
								A2(
									_user$project$Main$updatePosition,
									_p7._1,
									A2(_elm_community$array_extra$Array_Extra$getUnsafe, _p15, model.array)))
						}),
					{ctor: '[]'});
		}
	});
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Animation.Model.Tick":{"args":[],"tags":{"Tick":["Time.Time"]}},"Main.Msg":{"args":[],"tags":{"StartClicked":[],"NextStep":[],"Animate":["Int","Animation.Msg"],"StepForward":[],"StepBackward":[]}}},"aliases":{"Time.Time":{"args":[],"type":"Float"},"Animation.Msg":{"args":[],"type":"Animation.Model.Tick"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
