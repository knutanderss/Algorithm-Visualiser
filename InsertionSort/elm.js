...
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {array: a, steps: b, playing: c};
	});
...
var _user$project$Main$constructArray = function (numbers) {
			...
			A2(
				...
				A2(
					...
					A2(
						...
						function (_p4) {
							return _elm_lang$core$Basics$toFloat(
								_user$project$Main$calculateX(_p4));
						},
						indices)))));
	...
	return _elm_lang$core$Array$fromList(
		A5(
			...
			_user$project$Main$Element,
			numbers,
			indices,
			_user$project$Main$second(
				A2(
					_elm_lang$core$Debug$log,
					'styles',
					{
						ctor: '_Tuple2',
						_0: _elm_lang$core$List$length(styles),
						_1: styles
					})),
			colorList));
};
var _user$project$Main$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	{
		...
		steps: A2(
			_elm_lang$core$Debug$log,
			'steps: ',
			_user$project$Sort$animToSteps(
...
var _user$project$Main$TestClicked = {ctor: 'TestClicked'};
					...
					},
					{
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$TestClicked),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p5.ctor) {
			case 'NextStep':
				var _p6 = A2(_elm_lang$core$Debug$log, '', model.steps);
				if (_p6.ctor === '[]') {
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						model,
						...
						case 'Exchange':
							return A2(
								...
								_elm_lang$core$Native_Utils.update(
									model,
									{
										array: A3(_user$project$Main$stepExchange, _p6._0._0, _p6._0._1, model.array),
										steps: _p6._1
									}),
								model.playing ? {
									ctor: '::',
						...
						case 'LookAt':
							return A2(
								...
								_elm_lang$core$Native_Utils.update(
									model,
									{
										array: A3(_user$project$Main$setStatusInArray, _user$project$Main$LookedAt, _p6._0._0, model.array),
										steps: _p6._1
									}),
								model.playing ? {
									ctor: '::',
						...
						default:
							return A2(
								...
								_elm_lang$core$Native_Utils.update(
									model,
									{
										array: A3(_user$project$Main$setStatusInArray, _user$project$Main$Normal, _p6._0._0, model.array),
										steps: _p6._1
									}),
								model.playing ? {
									ctor: '::',
			...
			default:
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						...
						{
							array: function (e) {
								return A3(_elm_lang$core$Array$set, _p7, e, model.array);
							}(
								A2(
									_user$project$Main$updatePosition,
									_p5._1,
									A2(_elm_community$array_extra$Array_Extra$getUnsafe, _p7, model.array)))
						}),
					{ctor: '[]'});
		}
	});
